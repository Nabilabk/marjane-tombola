...
const DICT: Record<string, Entry> = {
  ...
  'topbar.clearAll': { fr: 'Tout supprimer', en: 'Clear all', ar: 'حذف الكل' },
  'topbar.deleteNotification': { fr: 'Supprimer la notification', en: 'Delete notification', ar: 'حذف الإشعار' },
  ...
  'mediaPicker.fromLibrary': { fr: 'Depuis la médiathèque', en: 'From the media library', ar: 'من مكتبة الوسائط' },
  ...
  'settings.fontModern': { fr: 'Modern — géométrique, épuré', en: 'Modern — geometric, clean', ar: 'Modern — هندسي وبسيط' },
  'settings.fontElegant': { fr: 'Elegant — serif raffiné', en: 'Elegant — refined serif', ar: 'Elegant — أنيق وكلاسيكي' },
  'settings.fontPlayful': { fr: 'Playful — rond, ludique', en: 'Playful — round, fun', ar: 'Playful — مرح ومستدير' },
  ...
  'themeEditor.showBrandName': { fr: 'Afficher le nom de la marque', en: 'Show brand name', ar: 'إظهار اسم العلامة' },
  'themeEditor.showBrandNameHint': { fr: 'Le nom écrit sous le logo, dans l\'en-tête. À désactiver si le logo contient déjà le nom.', en: 'The name printed under the logo, in the header. Turn off if the logo image already contains the name.', ar: 'الاسم المكتوب تحت الشعار في الترويسة. عطّله إذا كان الشعار يحتوي على الاسم بالفعل.' },
  ...
  'themeEditor.faviconHint': { fr: 'Apparaît dans l\'onglet du navigateur sur le site public — pas dans cet aperçu admin.', en: 'Shows in the browser tab on the public site — not in this admin preview.', ar: 'يظهر في علامة تبويب المتصفح على الموقع العمومي — وليس في هذه المعاينة الإدارية.' },
  'themeEditor.brandImages': { fr: 'Images de marque', en: 'Brand images', ar: 'صور العلامة التجارية' },
  'themeEditor.brandImagesHint': { fr: 'Affichées en bandeau de logos sous l\'en-tête du site.', en: 'Shown as a logo strip under the site header.', ar: 'تُعرض كشريط شعارات أسفل رأس الموقع.' },
  ...
  'products.errPriceRule': { fr: 'Définissez un seuil de dépense totale supérieur à 0.', en: 'Set a total spend threshold greater than 0.', ar: 'حدّد حدًا أدنى للإنفاق الإجمالي أكبر من 0.' },
  ...
  'products.perArticleThresholds': { fr: 'Par articles', en: 'Per-article thresholds', ar: 'حدود لكل مقال' },
  'products.priceThreshold': { fr: 'Par prix', en: 'By price', ar: 'بالسعر' },
  'products.andBothActive': { fr: 'ET — les deux conditions sont requises', en: 'AND — both conditions are required', ar: 'و — كلا الشرطين مطلوبان' },
  ...
  'products.totalQuantityGte': { fr: 'Quantité totale ≥', en: 'Total quantity ≥', ar: 'إجمالي الكمية ≥' },
  ...
  'assets.noFileData': { fr: "Ce fichier de démonstration n'a pas de contenu réel à télécharger.", en: "This demo asset has no real file content to download.", ar: 'لا يحتوي ملف العرض التوضيحي هذا على محتوى حقيقي للتنزيل.' },
  'assets.unsupportedType': {
    fr: 'Type de fichier non pris en charge — PNG, JPG, SVG ou PDF uniquement.',
    en: 'Unsupported file type — PNG, JPG, SVG, or PDF only.',
    ar: 'نوع ملف غير مدعوم — PNG أو JPG أو SVG أو PDF فقط.',
  },
  'assets.inUse': { fr: 'Utilisé', en: 'In use', ar: 'قيد الاستخدام' },
  'assets.documentsHint': {
    fr: 'Ce dossier contient le règlement de la tombola affiché sur le site. Déposer un nouveau PDF ici le remplace immédiatement ; le supprimer retire le lien du site.',
    en: 'This folder holds the tombola rules shown on the site. Dropping a new PDF here replaces it immediately; deleting it removes the link from the site.',
    ar: 'يحتوي هذا المجلد على شروط المسابقة المعروضة على الموقع. إفلات ملف PDF جديد هنا يستبدله فورًا؛ حذفه يزيل الرابط من الموقع.',
  },
  'assets.deleteInUseWarning': {
    fr: 'Il est actuellement utilisé sur le site (Éditeur de thème) — le supprimer le retirera aussi de là-bas.',
    en: "It's currently used on the site (Theme Editor) — deleting it removes it from there too.",
    ar: 'إنه مستخدم حاليًا في الموقع (محرر القالب) — حذفه سيزيله من هناك أيضًا.',
  },
  'assets.deleteRulesWarning': {
    fr: "C'est le règlement affiché sur le site — le supprimer retirera le lien du formulaire d'inscription.",
    en: "This is the rules doc shown on the site — deleting it removes the link from the entry form.",
    ar: 'هذا هو نظام المسابقة المعروض على الموقع — حذفه سيزيل الرابط من نموذج التسجيل.',
  },
  ...
  'notifications.deleteAll': { fr: 'Tout supprimer', en: 'Delete all', ar: 'حذف الكل' },
  'notifications.deleteAllConfirm': {
    fr: 'Supprimer toutes les notifications ? Cette action est irréversible.',
    en: 'Delete all notifications? This cannot be undone.',
    ar: 'حذف جميع الإشعارات؟ لا يمكن التراجع عن هذا الإجراء.',
  },
  'notifications.delete': { fr: 'Supprimer', en: 'Delete', ar: 'حذف' },
  'notifications.swipeHint': { fr: 'Glissez vers la gauche pour supprimer', en: 'Swipe left to delete', ar: 'اسحب لليسار للحذف' },
  ...
  'campaigns.reactivateTitle': { fr: 'Relancer la tombola', en: 'Relaunch the tombola', ar: 'إعادة تشغيل اليانصيب' },
  'campaigns.reactivateDesc': { fr: 'Cette tombola est terminée — sa date de fin est déjà passée. Choisissez une nouvelle date de fin avant de la relancer, sinon elle repassera aussitôt en « Terminée ».', en: 'This tombola has finished — its end date has already passed. Choose a new end date before relaunching it, or it will fall straight back into "Finished".', ar: 'انتهى هذا اليانصيب — تاريخ انتهائه مضى بالفعل. اختر تاريخ انتهاء جديدًا قبل إعادة تشغيله، وإلا سيعود فورًا إلى «منتهية».' },
  'campaigns.reactivateDateError': { fr: 'La nouvelle date de fin doit être dans le futur.', en: 'The new end date must be in the future.', ar: 'يجب أن يكون تاريخ الانتهاء الجديد في المستقبل.' },
  'campaigns.reactivateConfirm': { fr: 'Enregistrer et activer', en: 'Save and activate', ar: 'حفظ وتفعيل' },
